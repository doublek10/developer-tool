...
export interface ClonedAsset {
  url: string; kind: string; bytes: number; included: boolean; note: string | null;
}

export interface ClonedSite {
  source_url: string; final_url: string; title: string;
  html: string; css: string; js: string;
  assets: ClonedAsset[]; warnings: string[]; generated_at: string;
}

export interface ClonePlacement {
  root: string; index_path: string;
}
